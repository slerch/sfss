...
As a basic example, we will start by fitting a normal model of the form
\[
...
- are there more suitable parametric families for wind speed? (hint: `pnorm(0, n_mu, n_sigma)`)
